...
if (!process.env.DYNAMODB_DISCORD_NOTIFICATION_TABLE_NAME) {
  throw new Error("DYNAMODB_DISCORD_NOTIFICATION_TABLE_NAME is not defined");
}

export const DYNAMODB_DISCORD_NOTIFICATION_TABLE_NAME =
  process.env.DYNAMODB_DISCORD_NOTIFICATION_TABLE_NAME;
